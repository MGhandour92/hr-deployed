...
appConfig.smartSkin = "smart-style-100";
...
appConfig.apiRootUrl = 'app/_api';

appConfig.webApiUrl = 'http://192.168.1.240/HRSimplexApi/api'; // /sessions
appConfig.webUrl = 'http://192.168.1.240/HRSimplexApi'; // /sessions
appConfig.webReportsUrl = 'http://192.168.1.240/HRSimplexReports'; // /sessions

//appConfig.webApiUrl = 'http://localhost/HRSimplexApi/api'; // /sessions
//appConfig.webUrl = 'http://localhost/HRSimplexApi'; // /sessions


appConfig.applicationName = "HEBS"
...
.config(function ($provide, $httpProvider, RestangularProvider) {
    ...
    $provide.factory('ErrorHttpInterceptor', function ($q) {
        ...
        function notifyError(rejection){
            ...
            $.bigBox({
                //title: rejection.data.Message,//rejection.status + ' ' + rejection.statusText,
                //content: rejection.data.MessageDetail,
            ...
            resolve: {
                scripts: function(lazyScript){
                    return lazyScript.register([
                        'Scripts/build/vendor.datatables.js'
                    ]);
                }
            }
        })
...
$templateCache.put("app/_common/layout/directives/demo/demo-states.tpl.html","<div class=\"demo\">\r\n    <span id=\"demo-setting\"><i class=\"fa fa-cog txt-color-blueDark\"></i></span>\r\n\r\n    <form>\r\n        <legend class=\"no-padding margin-bottom-10\">Layout Options</legend>\r\n        <section>\r\n            <label>\r\n                <input type=\"checkbox\" ng-model=\"fixedHeader\"\r\n                       class=\"checkbox style-0\"><span>Fixed Header</span>\r\n            </label>\r\n            <label>\r\n                <input type=\"checkbox\"\r\n                       ng-model=\"fixedNavigation\"\r\n                       class=\"checkbox style-0\"><span>Fixed Navigation</span>\r\n            </label>\r\n            <label>\r\n                <input type=\"checkbox\"\r\n                       ng-model=\"fixedRibbon\"\r\n                       class=\"checkbox style-0\"><span>Fixed Ribbon</span>\r\n            </label>\r\n            <label>\r\n                <input type=\"checkbox\"\r\n                       ng-model=\"fixedPageFooter\"\r\n                       class=\"checkbox style-0\"><span>Fixed Footer</span>\r\n            </label>\r\n            <label>\r\n                <input type=\"checkbox\"\r\n                       ng-model=\"insideContainer\"\r\n                       class=\"checkbox style-0\"><span>Inside <b>.container</b></span>\r\n            </label>\r\n            <label>\r\n                <input type=\"checkbox\"\r\n                       ng-model=\"rtl\"\r\n                       class=\"checkbox style-0\"><span>RTL</span>\r\n            </label>\r\n            <label>\r\n                <input type=\"checkbox\"\r\n                       ng-model=\"menuOnTop\"\r\n                       class=\"checkbox style-0\"><span>Menu on <b>top</b></span>\r\n            </label>\r\n            <label>\r\n                <input type=\"checkbox\"\r\n                       ng-model=\"colorblindFriendly\"\r\n                       class=\"checkbox style-0\"><span>\r\n                    For Colorblind <div class=\"font-xs text-right\">\r\n                        (experimental)\r\n                    </div>\r\n                </span>\r\n            </label><span id=\"smart-bgimages\"></span>\r\n        </section>\r\n        <section>\r\n            <h6 class=\"margin-top-10 semi-bold margin-bottom-5\">Clear Localstorage</h6><a ng-click=\"factoryReset()\" class=\"btn btn-xs btn-block btn-primary\" id=\"reset-smart-widget\">\r\n                <i class=\"fa fa-refresh\"></i> Factory Reset\r\n            </a>\r\n        </section>\r\n\r\n        <h6 class=\"margin-top-10 semi-bold margin-bottom-5\">Skins</h6>\r\n\r\n        <section id=\"smart-styles\">\r\n            <a ng-repeat=\"skin in skins\" ng-click=\"setSkin(skin)\" class=\"{{skin.class}}\" style=\"{{skin.style}}\"><i ng-if=\"skin.name == $parent.smartSkin\" class=\"fa fa-check fa-fw\"></i> {{skin.label}} <sup ng-if=\"skin.beta\">beta</sup></a>\r\n        </section> \r\n    </form>\r\n</div>");}]);
'use strict';
...
angular.module('SmartAdmin.Layout').directive('widgetGrid', function ($rootScope, $compile, $q, $state, $timeout) {
    ...
    return {
        ...
        compile: function (element) {
            ...
            if (elementId == undefined || elementId == null) {
                elementId = 'widget-grid-';
            }

            element.id = elementId + parseInt(Math.random() * 10000);
            ...
            jarvisWidgetAddedOff = $rootScope.$on('jarvisWidgetAdded', function (event, widget) {
                if (widgetIds.indexOf(widget.widgetKey) == -1) {
                    widgetIds.push(widget.widgetKey);
                    $timeout(function () {
                        setupWidgets(element, widgetIds)
                    }, 100);
                }
